...
![[54132fc5-9235-48e3-9a0c-2ce93a7457a1 1.jpg]]

| 链路概览                                                                                                                                                                                                                  |     |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| #### 用户流程：<br>1.  用户上传 PSD 或图片文件<br>    <br>2.  系统解析文件结构<br>    <br>3.  用户进行基础编辑或 AI 分图层<br>    <br>4.  用户通过对话方式对单个图层进行 AI 修改<br>    <br>5.  选择目标尺寸进行自适应扩展<br>    <br>6.  用户导出最终文件<br>    <br>7.  （可选)批量套版：导入表格进行批量替换 |     |

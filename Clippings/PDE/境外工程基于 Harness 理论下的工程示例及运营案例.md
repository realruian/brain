...
`docs/knowledge/issues.md`（必须）；反复出现加入 `CLAUDE.md` 约束

CR 发现高频坏味道

`docs/knowledge/issues.md`；编码约束 → `CLAUDE.md`

新产品需求上线

`docs/specs/`（必须）；依赖变更 → `dependencies.md`
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)https://dev.sankuai.com/code/repo-detail/ba-csc/csc-oversea-workbench-bff/file/list
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)https://dev.sankuai.com/code/repo-detail/cs-fe/cs-fe-sep-i18n/file/list
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)https://dev.sankuai.com/code/repo-detail/ba-csc/aix-platform-oversea/file/list
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)https://dev.sankuai.com/code/repo-detail/cs-fe/cs-fe-config-i18n/file/list
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)https://dev.sankuai.com/code/repo-detail/ba-csc/oversea-csc-assistant-agent-service/file/list
...
![DevTools Code 链接的图标](https://s3plus.meituan.net/citadel-web/open_iframe/1695297606272.svg)PR  cs-fe/cs-fe-sep-i18n  refactor: cs-all-sdk sep-view-render-sdk移至lib [merged]
